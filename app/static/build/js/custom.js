...
function init_daterangepicker() {
    ...
    var optionSet1 = {
        ...
        ranges: {
            ...
            'Proximos 7 Dias': [moment().subtract(6, 'days'), moment()],
            'Proximos 30 Dias': [moment().subtract(29, 'days'), moment()],
            'Este Mês': [moment().startOf('month'), moment().endOf('month')],
            'Proximo Mês': [moment().subtract(1, 'month').startOf('month'), moment().subtract(1, 'month').endOf('month')]
        },
        opens: 'left',
    ...
    $('#reportrange').on('apply.daterangepicker', function(ev, picker) {
        console.log("apply event fired, start/end dates are " + picker.startDate.format('D MMMM, YYYY') + " - " + picker.endDate.format('D MMMM, YYYY'));
    });
...
function init_calendar() {
    ...
    var calendar = $('#calendar').fullCalendar({
        ...
        events: [{
            ...
            title: 'Click para Lumax',
            start: '2018-09-28',
            end: '2018-09-29',
            url: 'http://lumaxmovelaria.com.br/'
        },{
          title: 'Julio',
          start: '2018-09-18',
          end: '2018-09-20'
